...
object DaysInMonth:
  ...
  def monthName(month: Int): Option[String] = month match
    case 1 => Some("January")
  ...
  def days(month: Int, year: Int): Option[Int] = month match
    case 1 => Some(31)
    case 2 => if(isLeapYear(year)) Some(29) else Some(28)
    case 3 => Some(31)
    case 4 => Some(30)
    case 5 => Some(31)
    case 6 => Some(30)
  ...
  def main(args: Array[String]): Unit =
    ...
    while (true)
      ...
      monthName(month) match
        ...
        case None => println("That's not a valid month!")
      ...
      // days the month has.
      days(month, year) match
        case Some(days) => println(s"That month has $days")
        case None => println("Not valid month, cannot determine how many days")
